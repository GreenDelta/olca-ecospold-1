...
Namespace: `http://www.EcoInvent.org/EcoSpold01Impact`

## Dataset

A dataset describes LCIA related information of an impact category comprising metaInformation (description of the process) and flowData (quantified inputs and outputs and allocation factors, if any).
...
Contains metainformation about how impact categories are documented and about the review/validation of the dataset.
